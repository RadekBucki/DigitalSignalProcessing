...
public class MainFormController implements Initializable {
    ...
    private final List<TextField> parametersTextFields = new ArrayList<>();
    ...
    public void createSignalInstance() {
        List<Double> values = parametersTextFields.stream().map(
    ...
    private boolean shouldGenerateButtonBeDisabled() {
        ...
        for (TextField textField : parametersTextFields) {
