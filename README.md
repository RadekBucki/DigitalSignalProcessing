...
package backend {
    ...
    class SignalFacade {
        ...
        + sampling(ContinuousSignal, double): DiscreteSignal
        + quantizationWithTruncation(DiscreteSignal, int): DiscreteSignal
        + quantizationWithRounding(DiscreteSignal, int): DiscreteSignal
